...
router.post('/',[
    ...
    check('fullName', 'Length from 2 to 100').isLength({min: 2, max: 100}),
    check('position', 'Length from 1 to 100').not().isEmpty(),
    check('gender', 'Invalid number').isNumeric()
], (req, res) => {
    //validate data here
